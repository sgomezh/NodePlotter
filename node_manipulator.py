...
class NodeManipulator:
    ...
    def update(self) -> None:
        ...
        if self.node_selected is not None:
            ...
            self.label.append(self.font.render("Ev: " + str(round(-float(firstEv))), True, (255, 200, 200), (40, 40, 40)))
            self.label.append(self.font.render("Mean: " + str(round(-float(meanEv))), True, (255, 200, 200), (40, 40, 40)))
